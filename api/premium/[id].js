...
export default async function handler(req, res) {
  try {
    ...
    // MAC portal base URL
    const macAddress = "A0:BB:3E:A6:AB:CA"; // replace with actual MAC if needed
    const sourceUrl = `http://mag.premiumplus.tv:80/play/live.php?mac=${macAddress}&stream=${streamId}&extension=.m3u8`;
    ...
    const upstreamResp = await fetch(sourceUrl, {
      ...
      headers: {
        ...
        "Accept": "*/*",
        "Referer": "http://mag.premiumplus.tv",
        "Origin": "http://mag.premiumplus.tv"
      }
    });
